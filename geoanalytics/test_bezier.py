...
# -*- coding: utf-8 -*-
"""
Created on Wed Apr 12 06:53:16 2023
...
class Bezier:
    ...
    def findPoints(self):
        ...
        for i in range(self.n -1):# if you want a polygon then remove the '-1' from self.n -1
...
# point = np.array(curve.curve_pts) # Evaluated Points

from shapely.geometry import asLineString

linestring = asLineString(np.array(curve.curve_pts))
